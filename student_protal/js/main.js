...
(function(){
  ...
  if ($('user-info')) $('user-info').textContent = `Welcome, ${fullName} to your student portal!`;
  ...
  if (postArea && (role === 'staff' || role === 'admin' || role === 'HoD')) postArea.style.display = 'block';
  const adminDropdown = $('admin-dropdown');
  if (adminDropdown && (role === 'admin' || role === 'HoD')) adminDropdown.style.display = 'inline-block';
